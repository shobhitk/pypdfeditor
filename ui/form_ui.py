...
=======
        ...
        self.output_label.setObjectName("output_label")
        self.horizontalLayout.addWidget(self.output_label)
        self.output_path = QtWidgets.QLineEdit(parent=self.generate_frame)
        self.output_path.setObjectName("output_path")
        self.horizontalLayout.addWidget(self.output_path)
        self.generate_button = QtWidgets.QPushButton(parent=self.generate_frame)
        self.generate_button.setObjectName("generate_button")
        self.horizontalLayout.addWidget(self.generate_button)
        self.cancel_button = QtWidgets.QPushButton(parent=self.generate_frame)
        self.cancel_button.setObjectName("cancel_button")
        self.horizontalLayout.addWidget(self.cancel_button)
...
>>>>>>> 9a215d341ce55ce0b424daaee3ef62e901ec4db0
    ...
    def retranslateUi(self, pypdfeditor):
        ...
        self.output_path.setText(_translate("pypdfeditor", "Folder for generated files"))
        self.generate_button.setText(_translate("pypdfeditor", "Generate"))
        self.cancel_button.setText(_translate("pypdfeditor", "Cancel"))
